...
OWNER_ID = list(map(int, getenv("OWNER_ID", "5747046335").split()))
...
SUPPORT_CHANNEL = getenv("https://t.me/dramaticsticker")
SUPPORT_GROUP = getenv("https://t.me/dramaticClubb")
